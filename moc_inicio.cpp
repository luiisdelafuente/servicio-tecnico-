...
static const char qt_meta_stringdata_inicio[] = {
    "inicio\0\0cargararchivo()\0"
};
...
const QMetaObjectExtraData inicio::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject inicio::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_inicio,
      qt_meta_data_inicio, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &inicio::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_inicio))
